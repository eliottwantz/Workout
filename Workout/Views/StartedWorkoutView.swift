          ...
          DragGesture()
            .onEnded { value in
              ...
              if value.translation.width > 0 {
                // Swipe right
                guard startedWorkoutViewModel.currentSetIndex > 0 else { return }
                print("Swipe right")
                startedWorkoutViewModel.navigateToPreviousSet()
              } else {
                // Swipe left
                guard startedWorkoutViewModel.currentSetIndex < startedWorkoutViewModel.workoutSets.count - 1 else { return }
                print("Swipe left")
                startedWorkoutViewModel.navigateToNextSet()
              }
            }
